...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        # Define the key points of the court
    ...
    def set_canvas_background_box_position(self, frame):
        frame = frame.copy()
        self.start_x = frame.shape[1] - self.drawing_rectangle_width
        self.start_y = 0
        self.end_x = self.start_x + self.drawing_rectangle_width
        self.end_y = self.drawing_rectangle_height
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_key_points):
        ...
        default_player_height_meters = constants.DEFAULT_HEIGHT_METERS
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                if bboxes_heights_in_pixels:
                    ...
                    max_player_height_in_pixels = default_player_height_meters
